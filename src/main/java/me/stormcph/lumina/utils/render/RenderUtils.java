...
public class RenderUtils {
    ...
    public static void drawPlayerHead(DrawContext context, PlayerEntity player, float x, float y, int size) {
        ...
        PlayerSkinDrawer.draw(context, playerListEntry.getSkinTexture(), (int) x, (int) y, 15, bl3, bl22);
    }
    ...
    public static void drawScaledTexturedRect(DrawContext context, float x, float y, float scale, String path) {
        ...
        try {
            ...
            // Draw the image
            context.drawTexture(new Identifier("lumina", path), (int) (x / scale), (int) (y / scale), 0.0f, 0.0f, image.getWidth(), image.getHeight(), image.getWidth(), image.getHeight());
            matrices.pop();
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    public static void drawTexturedRectangle(DrawContext context, float x, float y, String path) {
        try {
            URL url = RenderUtils.class.getResource("/assets/lumina/" + path);
            BufferedImage image = ImageIO.read(url);
            context.drawTexture(new Identifier("lumina", path), (int) x, (int) y, 0.0f, 0.0f, image.getWidth(), image.getHeight(), image.getWidth(), image.getHeight());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void drawStringShadow(DrawContext context, String text, int x, int y, int color) {
    ...
    public static void drawString(DrawContext context, String text, double x, double y, int color) {
        drawString(context, text, (int) x, (int) y, color);
    }
}
