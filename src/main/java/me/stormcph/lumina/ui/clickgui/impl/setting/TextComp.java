...
public class  TextComp extends SettingComp {
    ...
    public void drawScreen(MatrixStack matrices, double mouseX, double mouseY, double y) {
       ...
       // drawRect(matrices, pX + 25, pY + pH + y, pX + pW - 25, pY + pH + y + 40, Color.green.getRGB());
        drawString(matrices, setting.getName() + ":" + text, pX + 30, pY + pH + y + 10, focused ? (ClickguiModule.uiTheme.getMode().equals("Dark") ? Color.white : Color.BLACK) : (ClickguiModule.uiTheme.getMode().equals("Dark") ? Color.GRAY : Color.lightGray));
    }
