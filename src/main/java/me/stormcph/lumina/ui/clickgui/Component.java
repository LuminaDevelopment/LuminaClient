...
public interface Component extends SFUtils {
    ...
    void drawScreen(DrawContext context, double mouseX, double mouseY);
    ...
    public abstract class PanelComponent implements SFUtils, Component {
        ...
        public abstract void drawScreen(DrawContext context, double mouseX, double mouseY, double y);
