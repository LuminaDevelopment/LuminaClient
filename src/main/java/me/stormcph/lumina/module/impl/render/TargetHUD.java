    ...
    public void draw(DrawContext context) {
        ...
        if (target == null) {
            ...
            if (mc.currentScreen instanceof HudConfigScreen) {
                RenderUtils.drawString(context, "TargetHUD", getX() + 10, getY() + 10, -1);
            }
            return;
        }
        ...
        drawRoundedRect(context, getX() * sf, getY() * sf, (getX() + getWidth()) * sf, (getY() + getHeight()) * sf, 5, 20, new Color(35, 35, 35));
        drawPlayerHead(context, target, (getX() + 5) * sf, (getY() + 7) * sf, 19);
        ...
        int x = getX() + 25;
        drawRect(context, x * sf, (getY() + 18) * sf, (int) (x + healthBarAnim.getValue()) * sf, (getY() + 28) * sf, -1);

        RenderUtils.drawString(context, target.getName().getString(), (getX() + 25), (getY() + 5), -1);
        ...
        RenderUtils.drawString(context, healthPercentage, (getX() + 27) , (getY() + 19) , Color.black.getRGB());
    }
